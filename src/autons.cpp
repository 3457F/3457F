...
void red_neg_awp_redo() {
    ...
    turnAndMoveToPoint(-60.171, 7.471, {.turnTO = 1000, .moveTO = 1000, .forwards = false });
    pros::delay(500);
    ...
    // -49.212, -1.908
    turnAndMoveToPoint(-50.094, 1.897, {.turnTO = 750 , .moveTO = 1250, .forwards = false, .mvMaxSpeed = 75.0});
    intake.lift(false);
    pros::delay(400);
